...
namespace API.Models
{
    ...
    public partial class QM_FT_LongAF_Wide_B_F15
    {
        ...
        public string from10cm { get; set; }
        public string real100cm { get; set; }
        public string through_Focus_BestAVG { get; set; }
        public string p_AF_Apply_Offset { get; set; }
        public string p_AF_Actual_Offset { get; set; }
        public string ft_Final_Apply_Offset { get; set; }
